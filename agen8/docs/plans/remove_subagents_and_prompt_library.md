...
| 5   | **Full suite** — Run `go test ./...` from agen8; fix any remaining failures; commit if any minor fixes.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | (only if needed)                                                          |
...
- [pkg/agent/loop.go](pkg/agent/loop.go): When base is empty, use `prompts.DefaultSystemPrompt()` (import `github.com/tinoosan/agen8/pkg/prompts`).
...
- Add import: `github.com/tinoosan/agen8/pkg/prompts`.
