...
func (r *markdownRenderer) get(width int) (*glamour.TermRenderer, error) {
	...
	style := agen8MarkdownStyle(r.variant)
...
func agen8MarkdownStyle(variant markdownVariant) ansi.StyleConfig {
	// "dark" matches the current Agen8 theme; it keeps transcript readable without
	...
	if variant == markdownVariantAgent {
		...
		style.Document.Color = stringPtr("15")
		style.Paragraph.Color = stringPtr("15")
		style.Text.Color = stringPtr("15")
		style.Heading.Color = stringPtr("15")
		style.H1.Color = stringPtr("15")
		style.H2.Color = stringPtr("15")
		style.H3.Color = stringPtr("15")
		style.H4.Color = stringPtr("15")
		style.H5.Color = stringPtr("15")
		style.H6.Color = stringPtr("15")
		style.List.Color = stringPtr("15")
		style.Item.Color = stringPtr("15")
		style.Enumeration.Color = stringPtr("15")
		style.Link.Color = stringPtr("15")
		style.LinkText.Color = stringPtr("15")
		style.Emph.Color = stringPtr("15")
		style.Strong.Color = stringPtr("15")
		style.Strikethrough.Color = stringPtr("15")
	}
