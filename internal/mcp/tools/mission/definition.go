...
func mustSchema() json.RawMessage {
	body, err := json.Marshal(map[string]any{
		...
		"properties": map[string]any{
			...
			"project_id":       stringSchema("Project id override for mission list/create. Defaults to the MCP session project."),
			...
			"space_id":         stringSchema("Owning space id for kr_assign_space."),
