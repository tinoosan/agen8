...
func TestApplyAllowedTools(t *testing.T) {
	...
	for _, name := range []string{"fs_list", "fs_stat", "fs_read", "fs_search", "fs_write", "fs_append", "fs_edit", "fs_patch", "fs_batch_edit", "fs_txn", "fs_archive_create", "fs_archive_extract", "fs_archive_list"} {
