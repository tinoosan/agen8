...
/* The metrics band reads the same two queries the dashboard already uses (tasks
 ...
 *
 * Only a HARNESS leaderboard exists: harness is auto-determined per member by
 * the Go daemon (HarnessFromJSONRPCBody), so it's real; model is not determined,
 * so a model leaderboard would be fabricated and is intentionally absent.
 */
