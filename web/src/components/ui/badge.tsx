  ...
  "inline-flex items-center rounded-full border border-transparent px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        outline: "bg-[var(--bg-elevated)] text-foreground",
        success:
          "border-transparent bg-[var(--green-dim)] text-[var(--green)]",
        warning:
          "border-transparent bg-[var(--amber-dim)] text-[var(--amber)]",
        danger:
          "border-transparent bg-[var(--red-dim)] text-[var(--red)]",
        info:
          "border-transparent bg-[var(--blue-dim)] text-[var(--blue)]",
        accent:
