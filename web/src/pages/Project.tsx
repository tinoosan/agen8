      ...
      <DialogContent data-tour-dialog="project" className="max-h-[calc(100vh-2rem)] max-w-[min(92vw,500px)] overflow-hidden rounded-[var(--r-xl)] border-[var(--border)] bg-[var(--bg-panel)] p-0 shadow-[var(--shadow-lg)] gap-0 [&>button]:hidden">
        ...
        <div className="min-w-0 overflow-x-hidden overflow-y-auto px-5 py-4">
          {locationsQuery.isLoading ? (
            ...
            <div className="flex flex-col gap-3 rounded-[var(--r-lg)] border border-[var(--border)] bg-[var(--bg-surface)] p-4 text-[13px] text-[var(--text-2)]">
            ...
            <>
              ...
              {currentStep === 'directory' && selectedLocation && (
                <div className="flex flex-col gap-3">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="inline-flex items-center gap-1.5 rounded-[var(--r-md)] border border-[rgba(107,138,253,0.2)] bg-[var(--accent-dim)] px-2 py-1 font-mono text-[11px] text-[var(--accent)]">
              ...
              {currentStep === 'details' && selectedPath && (
                <div className="flex flex-col gap-4">
                  {/* Selected path */}
                  <div>
                    <label className="text-[11px] font-semibold uppercase tracking-[0.06em] text-[var(--text-3)] mb-2 block">
                      Directory
                    </label>
                    <div className="flex items-center gap-2 rounded-[var(--r-md)] border border-[rgba(107,138,253,0.2)] bg-[var(--accent-dim)] px-3 py-2">
                      ...
                      <span className="truncate font-mono text-[12px] text-[var(--accent)]">
                        {selectedPath}
                      </span>
                      {selectedLocation && (
                        <span className="ml-auto shrink-0 rounded-full bg-[var(--bg-surface)] px-2 py-0.5 text-[10px] text-[var(--text-3)]">
                          {locationLabel(selectedLocation)}
                        </span>
                      )}
                    </div>
                  ...
                  {error && (
                    <div className="text-[12px] text-[var(--red)]">{error}</div>
                  )}
                </div>
              )}
            </>
    ...
    >
      ...
      <TableCell className="px-3 py-2.5">
        <div className="min-w-0">
          ...
          <div
            className="mt-0.5 truncate font-mono text-[11px] leading-tight text-[var(--text-3)]"
            title={project.root}
          >
      ...
      <TableCell className="w-[80px] px-3 py-2.5 text-right">
        <span
          className="whitespace-nowrap tabular-nums text-[12px] text-[var(--text-3)]"
      ...
      <AlertDialogContent className="bg-[var(--bg-panel)] border-[var(--border)] rounded-[var(--r-lg)] shadow-[var(--shadow-lg)] max-w-[min(92vw,420px)] p-0 gap-0">
        <AlertDialogHeader className="px-4 py-4">
          ...
          <AlertDialogDescription asChild>
            <div className="text-[13px] text-[var(--text-2)] leading-[1.6]">
...
function FilterChip({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={cn(
        'inline-flex items-center gap-1 whitespace-nowrap rounded-full border px-2.5 py-1 text-[11px] font-medium transition-colors cursor-pointer',
        active
    ...
    <div className="h-full overflow-y-auto">
      <div className="mx-auto w-full max-w-[960px] px-4 py-6 sm:px-6 md:px-10 md:py-8">
        ...
        <div className="flex items-center gap-3 mb-5 flex-wrap">
          <h1 className="m-0 text-[18px] font-semibold tracking-[-0.03em] text-[var(--text-1)] leading-[1.1] sm:text-[20px]">
            Projects
          </h1>
          <div className="flex-1" />
        ...
        {!isLoading && allProjects.length === 0 && (
          <div className="flex flex-col items-center justify-center py-16 gap-5 text-center sm:py-20">
            ...
            <div>
              <div className="font-semibold text-[16px] text-[var(--text-1)] mb-1.5 tracking-[-0.02em]">
            ...
            <div className="flex items-center gap-2 mb-4 flex-wrap">
              <div className="relative flex-1 min-w-[140px] max-w-[260px]">
                ...
                <Input
                  ...
                  className="h-[32px] pl-8 text-[12px]"
                />
              </div>
              ...
              <Table className="w-full">
                <TableHeader>
                  <TableRow className="border-[var(--border)] bg-[var(--bg-surface)] hover:bg-[var(--bg-surface)]">
                    <TableHead className="w-[28px] h-8 px-3 text-[10px] font-semibold uppercase tracking-[0.06em] text-[var(--text-3)]" />
                    ...
                    <TableHead className="w-[80px] h-8 px-3 text-right text-[10px] font-semibold uppercase tracking-[0.06em] text-[var(--text-3)]">
                      Activity
                    </TableHead>
