...
This document provides a high-level view of the Agen8 architectural components and their interactions during the lifecycle of a task.
...
The agen8 transitions tasks through the following lifecycle. Coordination tasks complete in Succeeded/Failed/Canceled; callbacks are separate tasks.
