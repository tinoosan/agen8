...
const (
	...
	CodeSpaceNotFound      = -32002
	CodeTurnNotFound       = -32003
	CodeItemNotFound       = -32004
	CodeTurnNotCancelable  = -32005
	CodeInvalidState       = -32006
	CodeAlreadyExists      = -32007
)

// ProtocolError is the handler/app-side RPC boundary error. It is converted into
// an RPCError during JSON-RPC response encoding.
...
// RPC returns the serialized JSON-RPC wire error object.
