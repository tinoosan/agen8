Here’s documentation for the `internal/skills/resource.go` module, written with the new **code-documentation** skill. This is aimed at Workbench engineers who need to understand or extend how the `/skills` virtual filesystem is exposed.

---
# Skills Resource (`internal/skills/resource.go`)
