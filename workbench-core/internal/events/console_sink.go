...
//
// Output format is intentionally stable:
//
//	{"type":"...","message":"...","data":{...}}
//
// The timestamp prefix is provided by the standard library log package, which matches
// the existing workbench demo behavior.
