// Package llm provides the Large Language Model (LLM) client abstraction for Workbench.
//
...
// # Stability
//
// The LLM contract is foundational to Workbench, so most exported interfaces in this
