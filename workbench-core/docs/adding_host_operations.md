# Adding Host Operations to Workbench

This document explains the architecture for adding new host operations (like `browser`, `shell_exec`, `http_fetch`) to the Workbench agent runtime.
...
The Workbench host operation pattern is:
