...
The Workbench App Server exposes a JSON-RPC 2.0 API over stdio. This protocol allows clients (such as the TUI or web interfaces) to manage threads, turns, and items, and to search artifacts.
